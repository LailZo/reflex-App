      ...
      return (
       <Router>
         ...
         <div id="home-background"></div>
            ...
            <Route path="/"  render={()=><Landing users={this.state.users}/>}/>
            <Route path="/catalog"  render={()=> <Catalog updateRent={this.updateRent}  user={this.state.users} state={this.state.movies} />}/>
            <Route path="/movies/:id"  render={({match}) => <MovieDetail movies={this.state.movies} match={match} />}/>
